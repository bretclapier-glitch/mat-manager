...
export default function BaseballLogin() {
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-white/60">Sign in to manage your organization</p>
          </div>
          ...
          <div className="bg-card rounded-2xl shadow-2xl p-8">
            <Tabs defaultValue="admin" className="w-full">
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input id="admin-email" type="email" placeholder="admin@baseballorg.com" value={email} onChange={(e) => setEmail(e.target.value)} className="pl-10" />
                    </div>
                  </div>
                  <div className="space-y-2">
                  ...
                  <Button type="submit" className="w-full bg-[hsl(150,45%,35%)] hover:bg-[hsl(150,45%,30%)] text-white" size="lg">Sign In as Admin</Button>
                </form>
              </TabsContent>
              ...
              <TabsContent value="parent">
                <form onSubmit={handleLogin} className="space-y-4">
                  ...
                  <Button type="submit" className="w-full bg-[hsl(150,45%,35%)] hover:bg-[hsl(150,45%,30%)] text-white" size="lg">Sign In as Parent</Button>
                </form>
              </TabsContent>
            </Tabs>
            ...
            <div className="mt-6 text-center text-sm text-muted-foreground">
              ...
              <Link to="/baseball/signup" className="text-[hsl(150,45%,45%)] font-semibold hover:underline">Get started</Link>
            </div>
          </div>
        </div>
      </div>
