...
export default function WrestlingSignup() {
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-card rounded-2xl shadow-2xl p-8">
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="clubName" type="text" placeholder="Thunder Wrestling Club" value={formData.clubName} onChange={(e) => setFormData({ ...formData, clubName: e.target.value })} className="pl-10" required />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="usaWrestlingId" type="text" placeholder="e.g., 123456" value={formData.usaWrestlingId} onChange={(e) => setFormData({ ...formData, usaWrestlingId: e.target.value })} className="pl-10" required />
                </div>
                <p className="text-xs text-muted-foreground">
                  Find your ID at{" "}
                  <a href="https://www.usawrestling.org" target="_blank" rel="noopener noreferrer" className="text-gold hover:underline">usawrestling.org</a>
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="email" type="email" placeholder="john@wrestlingclub.com" value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })} className="pl-10" required />
                </div>
              </div>
              ...
              <Button type="submit" variant="hero" className="w-full" size="lg">Create Club Account</Button>
            </form>
            ...
            <div className="mt-6 text-center text-sm text-muted-foreground">
              ...
              <Link to="/wrestling/login" className="text-gold font-semibold hover:underline">Sign in</Link>
            </div>
          </div>
        </div>
      </div>
