...
const upcomingEvents = [
  ...
  },
  {
    ...
    location: "Main Gym",
    wrestler: "Marcus Johnson",
    type: "practice",
  },
  {
    id: 3,
    title: "Austin Youth Tournament",
    date: "Feb 10, 2024",
...
const recentPayments = [
  {
    id: 1,
    description: "Middle School Registration",
    amount: 225,
    date: "Jan 15, 2024",
    status: "paid",
  },
  {
    id: 2,
    description: "Youth Wrestling Registration",
    amount: 175,
    date: "Jan 15, 2024",
    status: "paid",
  },
  {
    id: 3,
    description: "Tournament Fee - Austin Youth",
    amount: 35,
    date: "Feb 1, 2024",
    status: "pending",
  },
...
const announcements = [
  {
    id: 1,
    title: "Practice Cancelled Feb 8",
    message: "Due to facility maintenance, practice is cancelled on Thursday Feb 8.",
    date: "Feb 3, 2024",
    priority: "high",
  },
  {
    ...
    message: "Registration for the State Championship qualifier is now open.",
    date: "Feb 2, 2024",
    priority: "normal",
  },
];
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Button variant="ghost" size="icon" className="text-white relative">
              ...
              <span className="absolute -top-1 -right-1 w-4 h-4 bg-wrestling-red rounded-full text-[10px] flex items-center justify-center">
                2
              </span>
            </Button>
            <div className="flex items-center gap-3">
              <Avatar className="h-8 w-8">
                <AvatarFallback className="bg-gold text-navy text-sm">DJ</AvatarFallback>
              </Avatar>
              <span className="hidden sm:block text-sm">{parentInfo.name}</span>
            </div>
            <Link to="/login">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Manage your wrestlers, view schedules, and stay up to date with club announcements.
          </p>
        </div>
          ...
          <Card className="mb-6 border-wrestling-red bg-wrestling-red/5">
            <CardContent className="p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold text-wrestling-red">
                    {announcements.find((a) => a.priority === "high")?.title}
                  </p>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            {wrestler.program} • Age {wrestler.age}
                          </p>
                        </div>
                      </div>
                      <Badge
                        variant="outline"
                        className="bg-wrestling-green/10 text-wrestling-green border-wrestling-green/20"
                      >
                        {wrestler.status}
                      </Badge>
                    </div>
                    ...
                    <div className="grid sm:grid-cols-3 gap-4 text-sm">
                      <div className="flex items-center gap-2">
                        ...
                        <span>Next: {wrestler.nextPractice}</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <Trophy className="h-4 w-4 text-gold" />
                        <span>{wrestler.upcomingEvents} upcoming events</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <CheckCircle className="h-4 w-4 text-wrestling-green" />
                        <span>{wrestler.attendance}% attendance</span>
                      </div>
                    </div>
                  </div>
                ))}
          ...
          <div className="space-y-6">
            ...
            <Card className="shadow-card">
              <CardHeader>
                <CardTitle className="text-xl font-display">ANNOUNCEMENTS</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3">
